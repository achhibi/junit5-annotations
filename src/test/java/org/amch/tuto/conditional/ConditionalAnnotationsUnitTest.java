package org.amch.tuto.conditional;
...
public class ConditionalAnnotationsUnitTest {
    ...
    public void onlyRunsInFebruary() {
        log.debug("this test only runs in February");
    }
    ...
    public void notValidForIntelliJ() {
        log.debug("this test will run if our ide is INTELLIJ");
    }
    ...
    public void someSuperTestMethodHere() {
        log.debug("this method will run with java9, 10, 11 and Linux or macOS.");
    }
    ...
    @CoinToss
    public void gamble() {
        log.debug("This tests run status is a gamble with %50 rate");
    }
}
